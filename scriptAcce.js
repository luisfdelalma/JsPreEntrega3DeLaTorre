...
function renderAcceFiltrados(e) {
    let acceFiltrados =
        accesorios.filter(producto =>
            ...
            (producto.referencia.toLowerCase().includes(buscarAccesorios.value.toLowerCase()) && (producto.precio >= Number(desdeAcce.value) && producto.precio <= Number(hastaAcce.value)))
        )
...
function addCarritoAcce(e) {
    let prodBuscado = accesorios.find(producto => producto.referencia == e.target.id)
